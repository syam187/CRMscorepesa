<?php return array (
  ...
  array (
    ...
    array (
      ...
      '/api/v1/Metadata' => 'route12',
      '/api/v1/I18n' => 'route13',
      '/api/v1/Settings' => 'route14',
      '/api/v1/Stream' => 'route17',
      '/api/v1/GlobalSearch' => 'route18',
      '/api/v1/Admin/jobs' => 'route29',
      '/api/v1/CurrencyRate' => 'route35',
      '/api/v1/Email/inbox/notReadCounts' => 'route66',
      '/api/v1/Email/insertFieldData' => 'route67',
      '/api/v1/EmailAddress/search' => 'route68',
      '/api/v1/Oidc/authorizationData' => 'route76',
    ),
    'POST' => 
    array (
      '/api/v1/App/destroyAuthToken' => 'route11',
      '/api/v1/Admin/rebuild' => 'route27',
      '/api/v1/Admin/clearCache' => 'route28',
      '/api/v1/Action' => 'route37',
      '/api/v1/MassAction' => 'route38',
      '/api/v1/Export' => 'route41',
      '/api/v1/Import' => 'route44',
      '/api/v1/Import/file' => 'route45',
      '/api/v1/Attachment/fromImageUrl' => 'route54',
      '/api/v1/Email/sendTest' => 'route58',
      '/api/v1/Email/inbox/read' => 'route59',
      '/api/v1/Email/inbox/important' => 'route61',
      '/api/v1/Email/inbox/inTrash' => 'route63',
      '/api/v1/UserSecurity/apiKey/generate' => 'route70',
      '/api/v1/UserSecurity/password/recovery' => 'route72',
      '/api/v1/UserSecurity/password/generate' => 'route73',
      '/api/v1/User/passwordChangeRequest' => 'route74',
      '/api/v1/User/changePasswordByRequest' => 'route75',
      '/api/v1/Oidc/backchannelLogout' => 'route77',
    ),
    'PATCH' => 
    array (
    ...
    array (
      ...
      '/api/v1/Kanban/order' => 'route50',
      '/api/v1/UserSecurity/password' => 'route71',
    ),
    'DELETE' => 
    array (
